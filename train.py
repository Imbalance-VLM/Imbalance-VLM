...
from imblearn.algorithms import get_algorithm, name2alg
from imblearn.core.utils import get_net_builder, get_logger, get_port, send_model_cuda, count_parameters, over_write_args_from_file, TBLog


def get_config():
    from imblearn.algorithms.utils import str2bool
    ...
    parser.add_argument('--net_from_name', type=str2bool, default=False) # must be false
    ...
    parser.add_argument('-alg', '--algorithm', type=str, default='fullysupervised', help='ssl algorithm')
    ...
    '''
    parser.add_argument('--sample_type', type=str, default=None, help='sampling type')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if 'stage1_path' in args:
        try:
            ...
            logger.info("Fail to load path {}".format(args.stage1_path))    
